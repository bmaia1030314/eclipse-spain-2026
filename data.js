...
window.APP_DATA = {
  ...
  plans: {
    ...
    caxado: {
      ...
      spots: [
        {
          ...
          type: "montanha",
          distance: "near",
          distanceLabel: "Próximo (50 min de Lugo)",
        ...
        },
        {
          ...
          type: "elevado",
          distance: "medium",
          distanceLabel: "Médio (1h30 de Lugo)",
        ...
        },
        {
          ...
          type: "elevado",
          distance: "medium",
          distanceLabel: "Médio (1h10 de Lugo)",
        ...
        },
        {
          ...
          type: "plano",
          distance: "far",
          distanceLabel: "Longo (1h40 de Lugo)",
      ...
      hotels: [
        { name: "Eurostars Gran Hotel Lugo",
          notes: ["Reservado", "Central (Lugo)", "4 estrelas", "Fácil acesso à A-6", "Bom para família"] },
        { name: "Hotel Méndez Núñez (Lugo)",
          notes: ["Centro histórico de Lugo", "Junto à muralha romana", "Boa relação qualidade/preço"] },
        { name: "Pazo de Orbán (Lugo)",
          notes: ["Tranquilo", "Jardins", "Estacionamento", "Saída rápida para norte/AP-9"] },
        { name: "Hotel Balneario de Lugo",
          notes: ["Spa/termas", "Fora do centro (5 min de carro)", "Relaxar pós-eclipse"] }
      ],
